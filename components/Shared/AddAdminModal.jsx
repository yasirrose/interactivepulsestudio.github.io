...
const AddAdminModal = () => {
  return (
    <div className="modal fade" id="kt_modal_add_admin" tabIndex="-1" aria-hidden="true">
        ...
        <div className="modal-content">
          ...
          <div className="modal-body py-10 px-lg-17">
            <div className="scroll-y me-n7 pe-7" id="kt_modal_add_admin_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_admin_header" data-kt-scroll-wrappers="#kt_modal_add_admin_scroll" data-kt-scroll-offset="300px" style={{ maxHeight: '205px' }}>
              ...
              <div className="fw-bold fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_add_admin_billing_info" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">
                Shipping Information 
                <span className="ms-2 rotate-180">
                  <i className="ki-outline ki-down fs-3"></i>
                </span>
              </div>
              <div id="kt_modal_add_admin_billing_info" className="collapse show">
                ...
                <div className="fv-row mb-7">
                  <div className="d-flex flex-stack">
                    ...
                    <label className="form-check form-switch form-check-custom form-check-solid">
                      <input className="form-check-input" name="billing" type="checkbox" value="1" id="kt_modal_add_admin_billing" defaultChecked />
                      <span className="form-check-label fw-semibold text-muted" htmlFor="kt_modal_add_admin_billing">Yes</span>
                    </label>
                  </div>
                </div>
              </div>
