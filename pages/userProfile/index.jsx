                      ...
                      <div className="d-flex flex-wrap flex-sm-nowrap">
                        <div className="me-7 mb-4">
                          <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                            <Image src="./user-image.jpg" alt="User Image" />
                          ...
                          <div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            <div className="d-flex flex-column">
                              <div className="d-flex align-items-center mb-2">
                                <Link href="#" className="text-gray-900 text-hover-primary fs-2 fw-bold me-1">
                                  Max Smith
                                </Link>
                                <Link href="#" className="check-icon">
                                  <IoCheckmarkCircleOutline className="fs-1 text-primary" />
                                </Link>
                              </div>
                              <div className="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                <Link href="#" className="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
                                  <IoPersonOutline className="fs-4 me-1" /> Developer
                                </Link>
                                <Link href="#" className="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
                                  <IoLocationOutline className="fs-4 me-1" /> SF, Bay Area
                                </Link>
                                <Link href="#" className="d-flex align-items-center text-gray-500 text-hover-primary mb-2">
                            ...
                            <div className="d-flex my-4">
                              ...
                              <Link href="#" className="btn btn-sm btn-primary me-3">
                                Hire Me
                              </Link>
                            </div>
                          </div>
